package com.example.uilearning.paint;
...
public class PaintLayout extends View {
    ...
    public PaintLayout(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public PaintLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        mPaint.setStrokeCap(Paint.Cap.ROUND); //圆角效果(首尾添加)
...
//        int temp = 120;
//        canvas.drawLine(temp, temp, getMeasuredWidth() - temp, temp, mPaint);
//        mPaint.setStrokeCap(Paint.Cap.BUTT);
//        canvas.drawLine(temp, temp * 2, getMeasuredWidth() - temp, temp * 2, mPaint);
//        mPaint.setStrokeCap(Paint.Cap.SQUARE);
//        canvas.drawLine(temp, temp * 3, getMeasuredWidth() - temp, temp * 3, mPaint);
//        mPaint.setStrokeCap(Paint.Cap.ROUND);
//        canvas.drawLine(temp, temp * 4, getMeasuredWidth() - temp, temp * 4, mPaint);

//        mPaint.setStrokeJoin(Paint.Join.MITER);
//        canvas.drawLine(getMeasuredWidth()-temp,temp*4,getMeasuredWidth()-temp,temp*5,mPaint);
...
//        canvas.drawCircle(250,250,250,mPaint);
         ...
         */
//        mShader = new RadialGradient(250, 250, 250, new int[]{Color.RED, Color.BLUE, Color.GREEN}, new float[]{0.5f,0.7f,1}, Shader.TileMode.CLAMP);
//        mPaint.setShader(mShader);
//        canvas.drawCircle(250,250,250,mPaint);
